...
export function getSiteUrl(env = process.env) {
  let url = env.NEXT_PUBLIC_SITE_URL || env.VERCEL_PROJECT_PRODUCTION_URL || env.VERCEL_URL || 'https://daily-yong-sa.vercel.app';
...
export function getAuthCallbackUrl(env = process.env) {
